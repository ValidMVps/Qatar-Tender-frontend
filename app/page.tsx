    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="max-w-3xl reveal-on-scroll opacity-0 translate-y-8 transition-all duration-700 delay-100">
          {/* improve heading wrapping for small screens (hero) */}
          <h1 className="text-balance text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 font-sans leading-tight mb-6">
