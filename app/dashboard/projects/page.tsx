...
export default function Component() {
  ...
  return (
    <div className="flex w-full flex-col" style={{ height: "calc(100vh - 100px)" }}>
      <div className="grid flex-1 h-full overflow-hidden grid-cols-1 md:grid-cols-12">
        ...
        <div className="hidden flex-col col-span-3 h-full border-r bg-background md:flex">
          ...
          <div className="flex items-center mt-2 gap-2 p-4">
            <div className="relative w-full">
              ...
              <Input placeholder="Search projects..." type="search" className="pl-9" />
            </div>
          </div>
          {/* Project List */}
          <div className="flex-1 overflow-auto">
            <nav className="grid gap-1 px-4 text-sm font-medium">
              ...
              {/* Project 2 */}
              <Link href="#" className="flex flex-col gap-1 rounded-lg border p-3 hover:bg-muted/90" prefetch={false}>
                <div className="flex items-center justify-between">
                  <div className="font-semibold">Smart City Initiative Phase 2</div>
                  <div className="text-xs text-muted-foreground">1 week ago</div>
                </div>
                <div className="text-sm text-muted-foreground line-clamp-2">
                  Expansion of smart city technologies to new districts, focusing on IoT, public safety, and energy
                  efficiency.
                </div>
                <div className="flex flex-wrap gap-2 pt-2">
                  <Badge variant="secondary">Active</Badge>
              ...
              <Link href="#" className="flex flex-col gap-1 rounded-lg border p-3 hover:bg-muted/90" prefetch={false}>
                <div className="flex items-center justify-between">
                  <div className="font-semibold">Educational Facilities Upgrade</div>
                  <div className="text-xs text-muted-foreground">3 weeks ago</div>
                </div>
                <div className="text-sm text-muted-foreground line-clamp-2">
                  Modernization of existing educational facilities with new equipment, smart classrooms, and
              ...
              <Link href="#" className="flex flex-col gap-1 rounded-lg border p-3 hover:bg-muted/90" prefetch={false}>
                <div className="flex items-center justify-between">
                  <div className="font-semibold">National Green Spaces Program</div>
                  <div className="text-xs text-muted-foreground">1 month ago</div>
                </div>
                <div className="text-sm text-muted-foreground line-clamp-2">
                  Development of new parks, recreational areas, and urban green corridors across the country.
                </div>
                <div className="flex flex-wrap gap-2 pt-2">
                  <Badge variant="secondary">Active</Badge>
                </div>
        ...
        {/* Chat Section */}
        <ChatSection
          className="col-span-full md:col-span-9 lg:col-span-7"
      ...
      <ReviewDialog isOpen={isReviewDialogOpen} onOpenChange={setIsReviewDialogOpen} onSubmit={handleReviewSubmit} />
    </div>
  )
}
