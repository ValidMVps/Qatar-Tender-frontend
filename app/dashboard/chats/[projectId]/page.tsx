  ...
  "proj-1": [
    {
      ...
      sender: "other",
      content:
        "Hi! I'm ready to start on the website redesign. Do you have any initial thoughts on the color scheme?",
      timestamp: "10:00 AM",
    },
    {
      id: "m2",
    ...
    },
    {
      ...
      sender: "other",
      content:
        "Emerald sounds good! I'll put together some mockups for you to review by end of day.",
      timestamp: "10:10 AM",
    },
  ],
  "proj-3": [
    {
      ...
      timestamp: "monday_09_00_am",
    },
    {
      id: "m8",
      sender: "user",
      content:
        "Yes, please! Send them over. I'm excited to see what you've come up with.",
      timestamp: "monday_09_05_am",
    },
  ],
};
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <h1 className="text-2xl font-bold text-gray-700">
          {t("chat_not_found_for_this_project")}
        </h1>
      </div>
    );
  }
